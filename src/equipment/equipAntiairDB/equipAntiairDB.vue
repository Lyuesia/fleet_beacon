...
export default {
  ...
  mounted() {
    ...
    if (sessionStorage.getItem(("equipDBantiairBox")) != null) {
      this.equipBox = JSON.parse(sessionStorage.getItem("equipDBantiairBox"))
      this.equipType = JSON.parse(sessionStorage.getItem("equipDBantiairType"))
      this.equipTier = JSON.parse(sessionStorage.getItem("equipDBantiairTier"))
      this.equipRarity = JSON.parse(sessionStorage.getItem("equipDBantiairRarity"))
      this.equipName = JSON.parse(sessionStorage.getItem("equipDBantiairName"))
    }
  ...
  methods: {
    checkBoxToggle() {
      ...
      let self = this
      sessionStorage.setItem("equipDBantiairBox", JSON.stringify(this.equipBox))
      sessionStorage.setItem("equipDBantiairType", JSON.stringify(this.equipType))
      sessionStorage.setItem("equipDBantiairTier", JSON.stringify(this.equipTier))
      sessionStorage.setItem("equipDBantiairRarity", JSON.stringify(this.equipRarity))
      sessionStorage.setItem("equipDBantiairName", "null")
      this.$http.post("/equipfilter", {
        equipBox: this.equipBox,
        equipType: this.equipType,
        equipTier: this.equipTier,
    ...
    nameSearch() {
      ...
      sessionStorage.setItem("equipDBantiairName", JSON.stringify(this.equipName))
    },
    sortName() {
