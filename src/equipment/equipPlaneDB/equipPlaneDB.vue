    ...
    <div class="charListArea">
      <table class="charListTable">
        <tr class="outterBorder lightRoundBorder charListNavBar fullBox">
          ...
          <th class="statNav normalStatNav" @click="sortEtc" v-bind:class="{ active: etcNavbar }">기타</th>
        </tr>
        <tr class="charList" v-for="equip in filtered">
          ...
          <td class="stats">{{ equip.equipmaxairpower }}</td>
          <td class="stats">{{ equip.equipextraeffects }}</td>
        </tr>
      </table>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    ...
    if (sessionStorage.getItem(("equipDBplaneBox")) != null) {
      this.equipBox = JSON.parse(sessionStorage.getItem("equipDBplaneBox"))
      this.equipType = JSON.parse(sessionStorage.getItem("equipDBplaneType"))
      this.equipTier = JSON.parse(sessionStorage.getItem("equipDBplaneTier"))
      this.equipRarity = JSON.parse(sessionStorage.getItem("equipDBplaneRarity"))
      this.equipName = JSON.parse(sessionStorage.getItem("equipDBplaneName"))
    }
  ...
  methods: {
    checkBoxToggle() {
      ...
      this.etcNavbar = false
      let self = this
      sessionStorage.setItem("equipDBplaneBox", JSON.stringify(this.equipBox))
      sessionStorage.setItem("equipDBplaneType", JSON.stringify(this.equipType))
      sessionStorage.setItem("equipDBplaneTier", JSON.stringify(this.equipTier))
      sessionStorage.setItem("equipDBplaneRarity", JSON.stringify(this.equipRarity))
      sessionStorage.setItem("equipDBplaneName", "null")
      this.$http.post("/equipfilter", {
        equipBox: this.equipBox,
        equipType: this.equipType,
        equipTier: this.equipTier,
    ...
    nameSearch() {
      ...
      sessionStorage.setItem("equipDBplaneName", JSON.stringify(this.equipName))
    },
    sortName() {
    ...
    sortEtc() {
      ...
      this.etcNavbar = false
      if (this.sortOrder == "asc") {
        this.filtered.sort(function(a,b) {return (a.equipextraeffects > b.equipextraeffects) ? 1 : ((b.equipextraeffects > a.equipextraeffects) ? -1 : 0);} );
        this.sortOrder = "desc"
      }
      else {
        this.filtered.sort(function(a,b) {return (a.equipextraeffects < b.equipextraeffects) ? 1 : ((b.equipextraeffects < a.equipextraeffects) ? -1 : 0);} );
